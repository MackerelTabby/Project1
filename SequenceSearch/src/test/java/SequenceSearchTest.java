...
public class SequenceSearchTest {
    ...
    public void getAllTaggedSequences() throws Exception {
        ...
        s = String.format(s0, d0, d1, d0, d1, d0, d1, d0, d1, d0, d1, d0, d1);
        ...
        s = String.format(s1, d0, d1, d0, d1, d0, d1, d0, d1, d0, d1);
        ...
        s = String.format(s3, d0, d1, d0, d1, d0, d1);
        sa = new SequenceSearchImpl(s, d0, d1).getAllTaggedSequences();
        assertEquals("Java", sa[0]);
        assertEquals("2010", sa[1]);
    ...
    public void getLongestTaggedSequence() throws Exception {
        ...
        assertEquals("James Gosling", t);
        assertEquals("Sun Microsystems", t);
        assertEquals("OpenJDK.", t);
